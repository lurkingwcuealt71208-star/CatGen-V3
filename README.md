# CatGen-V3 - CURRENTLY OUTDATED! - UPDATE TO V5! *(V5 IS IN ALPHA STAGE AND IS MEANT TO PORT CATGEN TO MAC AND LINUX! - EXPECT GLITCHES AND ERRORS!)*
...
## CLICK ON THE GREEN BUTTON AND CLICK DOWNLOAD .ZIP!

EXTRACT THE GAME'S FILES, THEN OPEN THE EXTRACTED FOLDER.

FOLLOW STEPS 2 AFTER YOU INSTALLED PYTHON.
